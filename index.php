            ...
            <div class="col-lg-4 offset-lg-4 bg-light rounded" id="caixaLogin">
                ...
                <form id="formLogin" class="p-2">
                    ...
                    <div class="form-group">
                        <input type="text" name="nomeUsuario" id="nomeUsuario" class="form-control" placeholder="Nome do usuário" minlength="5" required value="<?php if (isset($_COOKIE['nomeUsuario']))
                    echo $_COOKIE['nomeUsuario']; ?>">
                    </div>

                    <div class="form-group">
                        <input type="password" name="senhaUsuario" id="senhaUsuario" class="form-control" placeholder="Senha" required minlength="6" value="<?php if (isset($_COOKIE['senhaUsuario']))
                     echo $_COOKIE['senhaUsuario'] ?>">
                    </div>

                    <div class="form-group mt-5">
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" name="lembrar" id="lembrar" class="custom-control-input" <?php if (isset($_COOKIE['nomeUsuario']))
                         echo " checked"; ?>>
        ...
        <section class="row mb-5">
            <div class="col-lg-4 offset-lg-4 bg-light rounded" id="caixaCadastro">
                ...
                <form action="#" class="p-2" id="formCadastro">
                    ...
                    <div>
                        <input type="text" name="imagens" id="imagens" class="form-control" placeholder="URL da imagem" required>
                    </div>
